...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (response.success) {
      toast.success('You account is created , now please login', {
        position: "top-center",
        autoClose: 2000,
  ...
  return (
    <>
      <Head>
        <title>Signup - Farmfreshz.com fresh veggies & fruits </title>
                  ...
                  <div className="lg:w-6/12 px-4 md:px-0">
                    <div className="md:p-12 md:mx-6">
                      ...
                      <div className="text-center">
                        <img
                          className="mx-auto lg:w-48 md:w-48 w-24 rounded-full"
                          src="/logo1.jpg"
                          alt="logo"
                        />
                        <h2 className="text-3xl  font-semibold mt-1 mb-6 pb-1">Your friendly farmers at your doorstep</h2>
                      </div>

                      <form onSubmit={handleSubmit} method="POST">
                        <p className="mb-2 text-center  font-bold text-2xl text-green-900 ">Please
                        ...
                        <div className="text-center pt-1 mb-12 pb-1">
                          <button type="submit"
                            ...
                            font-semibold text-sm leading-tight uppercase rounded bg-green-300 shadow-md  active:bg-green-200 hover:bg-green-700 hover:shadow-lg w-72 mb-3 hover:border-transparent ">Sign Up  </button>
